...
export const ja = {
  ...
  "storage.toast.undo": "元に戻す",
  "storage.toast.restored": "削除を取り消しました。",
  "storage.toast.restoreFailed": "元に戻せませんでした。",
  ...
  "strength.title": "プロトコル強度θ（交絡を外した推定）",
  ...
  "strength.betaBySlice.ratio":
    "レシオ戦: 先攻勝率 {rate}%（β = {beta}、{games}試合）",
  "strength.explain":
  ...
  "quadrant.totalGames": "n = {n} 試合",
  "quadrant.sizeNote": "● の大きさ = ピック数",
